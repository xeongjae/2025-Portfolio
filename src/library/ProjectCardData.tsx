...
export const ListChart: ProjectData[] = [
  {
    ...
    Description: `연극을 찾고 홍보할 수 있는 연극 정보 사이트입니다.
...
티니박스 프로젝트 중 사이드 프로젝트로 진행하였습니다.`,
  ...
  },
  {
    ...
    SubTitle: "",
    Description: `새롭고 세련된 디자인으로 리뉴얼한 포트폴리오입니다.
컴포넌트 재사용성과 사용자 인터페이스를 개선했습니다.`,
  ...
  },
  {
    ...
    SubTitle: "",
    Description: `디자인, 기능, 배포까지 직접 작업한 포트폴리오입니다.
다양한 애니메이션과 라이브러리를 활용하였습니다.`,
  ...
  },
  {
    ...
    SubTitle: "",
    Description: `분실물을 공유하고 주인과 매칭을 도와주는 서비스입니다.
프로젝트 팀 리드 및 추가 채팅기능 구현을 담당했습니다.`,
    ImageSrc: laf,
  ...
  },
  {
    ...
    SubTitle: "",
    Description: `반려 식물 및 가드닝 도구를 판매하는 쇼핑몰 서비스입니다.
